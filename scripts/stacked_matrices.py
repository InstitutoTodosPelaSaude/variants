...
if __name__ == '__main__':
    ...
    parser.add_argument("--extra-columns", required=False, nargs='+', help="Extra columns with extra info to export")
    ...
    # path = '/Users/Anderson/Library/CloudStorage/GoogleDrive-anderson.brito@itps.org.br/Outros computadores/My Mac mini/google_drive/github_old/labresults/omicron/run1_20211221_sgtf/'
    ...
    if extra_cols == None:
        ...
        if os.path.isfile(str(extra_cols)):
    ...
    for idx, row in df1.iterrows():
        ...
        for time_point in date_columns:
            ...
            if variable1 in ['', None, np.nan]:
                # print(variable1)
                variable1 = 'X'
            if input2 not in ['', None]:
                variable2 = df2.loc[idx, time_point]
                if variable2 in ['', None, np.nan]:
                    variable2 = 'X'
